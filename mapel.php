<?php 
 ...
 include 'koneksi.php'; 
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = mysqli_query($conn, "SELECT * FROM mapel WHERE id_mapel='$id'");
    if (count($sql) == 1 ) {
  ...
  <div id="wrapper">
    ...
    <!--  <li class="nav-item ">
      ...
      <li class="nav-item ">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="Setting" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="Setting">Login Screens:</h6>
          ...
          <div class="box box-primary">
            <!-- <form method="post" action="addCustomer.php"> -->
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6"> 
                    <?php
                      if (isset($_GET['id'])) {
                          echo '<form method="post" action="simpan_mapel.php?id='.$id.'">';                    
                      } else {
                          echo '<form method="post" action="simpan_mapel.php">';                    
                      }
                    ?>                  
                    <div class="form-group">
                        <label for="exampleInputEmail1">Mata Pelajaran </label>
                        <input type="text" class="form-control" name="mapel" placeholder="Mata Pelajaran" value="<?php echo $mapel;?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">KKM </label>
                        <input type="text" class="form-control" name="KKM" placeholder="Bobot" value="<?php echo $kkm;?>">
                    </div>  
                  </div>
                </div>
              </div>
              ...
              <div class="box-footer">
                  ...
                  <a href="mapel.php" class="btn btn-warning">Cancel</a>
              </div>
              </form>
            </div>
          </div>
