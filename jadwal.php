                        ...
                        <div class="col-md-6">
                         <form> 
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nama" placeholder="Kelas" value="">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Senin </label>
                              <select type="text" class="form-control" name="Senin" placeholder="Pilih Mata Pelajaran">
                              ...
                              <select type="text" class="form-control" name="Selasa" placeholder="Pilih Mata Pelajaran">
                                <option value="">Nama Guru</option>
                                <option value="">-</option>
                                <option value="">Guru</option>
                              ...
                              <select type="text" class="form-control" name="Rabu" placeholder="Pilih Mata Pelajaran">
                                <option value="">Nama Guru</option>
                                <option value="">-</option>
                                <option value="">Guru</option>
                              ...
                              <select type="text" class="form-control" name="kamis" placeholder="Pilih Mata Pelajaran">
                                <option value="">Nama Guru</option>
                                <option value="">-</option>
                                <option value="">Guru</option>
                              ...
                              <select type="text" class="form-control" name="jumat" placeholder="Pilih Mata Pelajaran">
                                <option value="">Nama Guru</option>
                                <option value="">-</option>
                                <option value="">Guru</option>
                          ...
                          <div class="box-footer">
                              ...
                              <a href="jadwal.php" class="btn btn-warning">Cancel</a>
                          </div>
                          </form>
                        </div>
                      </div>
